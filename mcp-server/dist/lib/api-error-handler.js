...
exports.classifyAndFormatError = classifyAndFormatError;
...
function createErrorResponse(error) {
    ...
    return server_1.NextResponse.json(errorResponse, {
...
async function withApiErrorHandling(operation) {
    try {
...
function validateEnvironmentVariables(required) {
