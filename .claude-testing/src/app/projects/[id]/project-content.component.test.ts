...
const { ProjectContent } = require('../../../../../src/app/projects/[id]/project-content.tsx');

describe('ProjectContent', () => {
  let renderResult: RenderResult;

  beforeEach(() => {
    renderResult = render(<ProjectContent />);
  });
  ...
  it('should have correct TypeScript props', () => {
    ...
    const { container } = render(<ProjectContent />);
    ...
    commonProps.forEach((props, index) => {
      try {
        const { unmount } = render(<ProjectContent {...props} />);
